...
function deleteState() {
    ...
    $.ajax({
        ...
        changeFormStateToNew();
        showToastMessage("State has been removed");
    }).fail(function () {
...
function updateState() {
    ...
    $.ajax({
        ...
        showToastMessage("New state has been updated")
        changeFormStateToNew();
    }).fail(function () {
        showToastMessage("ERROR")
    })
...
function addState() {
    ...
    $.ajax({
        ...
        showToastMessage("New state has been added")
    }).fail(function () {
        showToastMessage("ERROR")
    })
}
...
function loadStates4Country() {
    ...
    $.get(url, function (responseJSON) {
        ...
        changeFormStateToNew();
        showToastMessage("All states has been loaded for country " + selectedCountry.text());
    }).fail(function () {
        showToastMessage("ERROR");
    })
}
