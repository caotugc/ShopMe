...
public class CategoryService {
	public static final int ROOT_CATEGORIRES_PER_PAGE = 4;
	...
	public List<Category> listByPage(CategoryPageInfo pageInfo, int pageNum, String sortDir, String keyword) {
		...
		Pageable pageable = PageRequest.of(pageNum - 1, ROOT_CATEGORIRES_PER_PAGE, sort);
	...
	public Category get(Integer id) throws CategoryNotFoundException {
		try {
			...
			throw new CategoryNotFoundException("Could not fint any category with ID" + id);
		}
	}
