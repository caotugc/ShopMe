...
public class CategoryController {
	...
	public String listByPage(@PathVariable(name = "pageNum") int pageNum, @Param("sortDir") String sortDir,
		...
		long startCount = (pageNum -1) * CategoryService.ROOT_CATEGORIRES_PER_PAGE + 1;
		long endCount = startCount + CategoryService.ROOT_CATEGORIRES_PER_PAGE - 1;
